...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    public static class AppSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int i) {
            switch (i) {
                ...
                default:
                	// This is an error really and should never happen. Until I know how to deal with that, return Queue List
                    return new QueuesFragment();
            }
        }
     ...
     * create activity. 
     * 
     * This would normally be done in the onCreate method. However, as we can not load data from the server
     * until it has been configured, it is extracted here and called from onResume when details of a server
     * are available.
     */
	private void create()
	{
